...
const RegisterPage = () => {
  ...
  return (
    <PageWrapper fullHeight>
      <div className="mx-auto w-full max-w-6xl px-6 relative py-10">
        <motion.div
            ...
            >
              ...
              >
                <div className="rounded-2xl p-4 text-center sm:text-left shadow-sm" style={{ backgroundColor: 'var(--color-surface-elevated)', border: '1px solid var(--color-border)' }}>
                  ...
                  <h3 className="mt-3 text-base font-bold" style={{ color: 'var(--color-text)' }}>Smart Curation</h3>
                ...
                <div className="rounded-2xl p-4 text-center sm:text-left shadow-sm" style={{ backgroundColor: 'var(--color-surface-elevated)', border: '1px solid var(--color-border)' }}>
                  ...
                  <h3 className="mt-3 text-base font-bold" style={{ color: 'var(--color-text)' }}>Agent Logic</h3>
                  <p className="mt-1 text-xs" style={{ color: 'var(--color-text-secondary)' }}>
