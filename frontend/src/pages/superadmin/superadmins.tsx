...
const SuperAdminsPage = () => {
    ...
    // Client-side filtering on active status
    const filteredAdmins = superAdmins.filter(admin => {
        if (statusFilter === 'all') return true
        const isActive = admin.user.isActive
                        ...
                        {filteredAdmins.length === 0 ? (
                            <div className="px-5 py-16 text-center">
                                <svg viewBox="0 0 24 24" className="h-10 w-10 mx-auto mb-3" fill="currentColor" style={{ color: 'var(--color-text-tertiary)' }}>
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4.5h-2V7h2v5.5z" />
                                </svg>
                            ...
                            >
                                ...
                                <span>
                                    <span
                                        ...
                                        style={{
                                            backgroundColor: admin.user.isActive ? 'var(--color-success-light)' : 'var(--color-error-light)',
                                            color: admin.user.isActive ? 'var(--color-success)' : 'var(--color-error)',
                                        }}
                                    >
