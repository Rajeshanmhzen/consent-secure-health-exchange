...
const ICONS = {
    ...
    performance: <svg viewBox="0 0 24 24" className="h-5 w-5 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="m7 16 4-5 3 3 5-7"/></svg>,
}
...
const ROLE_NAV: Record<string, { label: string; to: string; icon: React.ReactNode }[]> = {
    SUPER_ADMIN: [
        ...
        { label: 'API Performance', to: '/dashboard/api-performance', icon: ICONS.performance },
    ],
    HOSPITAL_ADMIN: [
        { label: 'Dashboard',     to: '/dashboard',           icon: ICONS.dashboard },
